...
import groups1 from "../../../assets/images/groups/1.jpg";
...
<Link to="javascript:void(0)"><span>
...
<Link to="#"> MC and events </Link>
</div>
</div>
<div className="img_less-file">
<Link to="#"><img src={groups1} alt=""/></Link>
</div>
<div className="view_and_downloads_owner">
<div className="owner_name_pic">
<div className="profil_user_groups">
<span className="user_profile_gr"><img src={f1} alt=""/></span>
</div>
<div className="owne_anme_with-name">
<p>Owner<Link to="#">Deborah Theron</Link></p>
</div>
</div>
<div className="left_view">
<p>Members:  <Link to="#"> 33 </Link></p>
</div>
<div className="left_view">
<p>Files <Link to="#"> 33 </Link></p>
</div>
</div>
</div>
<div className="first_box_uploads">
    ...
    <div className="modal-content">
      ...
      <div className="modal-body">
        <label for="message-text artic" className="form-control-label">Write  article Here...<span
         className="art-writ_penc"><img src={write_art} alt=""/></span> </label>
